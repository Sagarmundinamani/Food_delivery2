...
public class UserDaoImpl implements UserDAO {
    ...
    private static final String INSERT_QUERY =
        "INSERT INTO user (userName, email, phoneNumber, password, address, role, createdDate) " +
        "VALUES (?, ?, ?, ?, ?, ?, NOW())";
    ...
    private static final String UPDATE_USER =
        "UPDATE user SET userName = ?, email = ?, phoneNumber = ?, password = ?, address = ?, role = ? " +
        "WHERE userId = ?";
    ...
    public User loginUser(String email, String password) {
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                try (PreparedStatement ps = con.prepareStatement(UPDATE_LAST_LOGIN)) {
